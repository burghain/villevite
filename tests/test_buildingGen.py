from bl_ext.user_default.citygen.buildings.buildingGenerator import buildingGenerator
import bpy
import pytest
import os


def test_building_gen():
    assert True
...
#         """Set up a clean Blender environment for each test"""
...
#     def test_building_generator_creates_instances(self, clean_scene):
...
#         assert (
#             len(mesh.vertices) > 4
#         ), "No geometry was generated beyond the original plane"
